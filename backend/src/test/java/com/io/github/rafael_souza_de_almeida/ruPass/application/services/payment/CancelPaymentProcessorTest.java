...
public class CancelPaymentProcessorTest {

    @InjectMocks
    CancelledPaymentProcessor processor;

    @Test
    @DisplayName("Should process cancelled payment")
    void shouldProcessCancelledPayment() {
